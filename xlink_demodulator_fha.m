...
%%Raised cosine FIR filter design FIRRCOS(N,Fc,DF,Fs)
%returns an order N low pass linear phase FIR  
...
r=-1;
    for i=1:260000,
        ...
        %r=r;%CW carrier, unmoduliert %continuous wave (CW)
        %r=-r;%acquisition data 0101010...
        %%%Tx_Daten mit 16 Samplewerten pro Symbol
        a(16*(i-1)+1)=r;
        if i==14991
        a(16*(i-1)+1)=1;
        end;%Tx_Daten mit 16 Samplewerten pro Symbol
...
korr_messwert=0;
%%% random initial phase of the Tx signal
